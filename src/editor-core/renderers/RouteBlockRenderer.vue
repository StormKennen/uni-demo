...
import type { RouteBlockData } from '../schemas/blocks/route-block.schema'
...
.rbr-start-time { display: block; font-size: 22rpx; color: #667eea; margin-bottom: 4rpx; }
.rbr-name-row {
  display: flex;
...
.rbr-meta { display: flex; align-items: center; gap: 8rpx; margin-top: 8rpx; font-size: 22rpx; color: #667eea; }
.rbr-meta-divider { color: #aaa; }
.rbr-address { display: block; margin-top: 6rpx; font-size: 22rpx; color: #888; }
.rbr-empty {
  padding: 40rpx;
  text-align: center;
  color: #aaa;
