  ...
  <DraftPanelShell
    ...
    <view class="mis-section">
      ...
      <view class="mis-prop-row">
        ...
        <switch :checked="draft.controls !== false" @change="draft.controls = $event.detail.value" color="#667eea" />
      </view>
      <view class="mis-prop-row">
        <text class="mis-label">自动播放</text>
        <switch :checked="draft.autoplay === true" @change="draft.autoplay = $event.detail.value" color="#667eea" />
      </view>
      <view class="mis-prop-row">
        <text class="mis-label">循环播放</text>
        <switch :checked="draft.loop === true" @change="draft.loop = $event.detail.value" color="#667eea" />
      </view>
    </view>
