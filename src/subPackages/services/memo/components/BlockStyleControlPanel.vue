    ...
    <view class="bcp-section">
      ...
      <view v-show="open.advanced" class="bcp-section-body">
        ...
        <view class="bcp-switch-row">
          ...
          <switch :checked="draft.style.locked === true" @change="draft.style.locked = $event.detail.value" color="#e6a23c" />
        </view>
        ...
        <view v-if="blockType === 'text'" class="bcp-switch-row">
          ...
          <switch :checked="draft.business.isMarkdown === true" @change="draft.business.isMarkdown = $event.detail.value" color="#667eea" />
        </view>
        ...
        <view v-if="blockType === 'route'" class="bcp-switch-row">
          ...
          <switch :checked="draft.business.showTime !== false" @change="draft.business.showTime = $event.detail.value" color="#667eea" />
        </view>
        ...
        <view v-if="blockType === 'image'" class="bcp-switch-row">
          ...
          <switch :checked="draft.style.enable3DMode === true" @change="draft.style.enable3DMode = $event.detail.value" color="#667eea" />
        </view>
...
<script setup lang="ts">
  ...
  const {
    ...
    cancel,
    save,
  } = useDraftPanel<{ style: any; business: Record<string, any> }>({
