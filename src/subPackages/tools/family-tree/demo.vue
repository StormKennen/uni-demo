    ...
    children: [
      ...
      },
      {
        ...
        children: [
          {
            name: '孙节点2-1',
            children: [{ name: '曾孙节点2-1-1' }, { name: '曾孙节点2-1-2' }, { name: '曾孙节点2-1-3' }],
          },
          { name: '孙节点2-2' },
          { name: '孙节点2-3' },
        ],
      ...
      {
        name: '子节点3',
        children: [{ name: '孙节点3-1' }, { name: '孙节点3-2' }],
      },
    ],
  })
  state.option = {
  ...
  const transformApiDataToTreeData = apiData => {
    ...
    const transformNode = (node, depth = 0) => {
      ...
      if (node.children && Array.isArray(node.children) && node.children.length > 0) {
        ...
        const validChildren = node.children.map(child => transformNode(child, depth + 1)).filter(child => child !== null)
  ...
  const loadFamilyTree = async () => {
    try {
      ...
      const res = {
        ...
        requestId: '29f05088-1e59-4bbe-8ca9-e63b7830cce5',
        timestamp: 1761968395254,
      }
