...
export const holidays: Record<string, HolidayInfo> = {
  ...
  '2026-05-09': { type: 'work', name: '劳动节调休' },
  // 端午节：6月19日至21日放假，不调休
  ...
  '2026-09-20': { type: 'work', name: '国庆调休' },
  '2026-10-10': { type: 'work', name: '国庆调休' },
}
