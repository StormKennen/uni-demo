  ...
  <view class="share-wrap">
    <view class="left-wrap">
      ...
      <view class="title-wrap">
        <view>kai港生活</view>
        <view class="sub-title"> 美好新生活从这里开始 </view>
      </view>
    </view>
    <view class="right-wrap">
      <view v-if="hideHeaderBtn === false" class="right-btn" @click="onClickHeaderBtn">
        {{ props.headerBtnText }}
      </view>
    </view>
  </view>
  <view v-if="!hideWrap" class="go-app-wrap">
    <view class="go-app-btn" @click="openApp"> 打开APP </view>
  </view>
</template>
