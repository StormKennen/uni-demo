<template>
  <BaseCard
    ...
    :required="required"
    :cards="cards"
    :showExample="!!exampleImages.length"
    :disabled="disabled">
  </BaseCard>
  <!-- 示例弹窗 -->
  <MyPopup v-model="visibleExample" type="bottom" backgroundColor="inherit" :safe-area="false" @change="popupChange">
    <view class="example-popup">
      ...
      <view style="padding: 0 40rpx 60rpx">
        ...
        <view class="example-images">
          <image class="id-front" v-for="imgItem in exampleImages" :key="imgItem" :src="imgItem" mode="widthFix"> </image>
        </view>
  ...
  <UploadPopup
    ...
    :cdpUploadOptions="visibleUploadPopupData.cdpUploadOptions">
  </UploadPopup>
</template>
