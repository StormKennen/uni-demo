  ...
  <view style="width: 100%">
    ...
    <uni-popup
      ...
      <view class="ga-picker-popup" @touchmove.prevent>
        ...
        <picker-view :value="pickerValue" class="ga-picker-view" @change="handleChange">
          <picker-view-column>
            <view
              class="picker-item picker-item-year"
          ...
          <picker-view-column>
            <view
              class="picker-item picker-item-month"
          ...
          <picker-view-column>
            <view
              class="picker-item picker-item-day"
...
<script setup lang="ts">
  ...
  onMounted(() => {
    ...
    if (props.modelValue) {
      ...
      pickerValue.value = [years.value.indexOf(parseInt(year)), months.value.indexOf(parseInt(month)), days.value.indexOf(parseInt(day))]
    } else {
      pickerValue.value = [years.value.indexOf(currentYear), months.value.indexOf(currentMonth), days.value.indexOf(currentDay)]
    }
  })
