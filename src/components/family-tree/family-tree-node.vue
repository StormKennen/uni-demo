  ...
  <view
    ...
    <view class="node-main">
      ...
      <view class="avatar-container">
        <image v-if="node.avatar" :src="node.avatar" class="avatar" mode="aspectFill" />
    ...
    <view v-if="node.spouse && config.showSpouses" class="spouse-container">
      ...
      <view class="spouse-node" :class="`gender-${node.spouse.gender}`">
        <view class="spouse-avatar">
          <image v-if="node.spouse.avatar" :src="node.spouse.avatar" class="avatar" mode="aspectFill" />
          <view v-else class="avatar-placeholder">
    ...
    <!-- 子节点展开/收起按钮 -->
    <view v-if="node.children.length > 0" class="expand-btn" @click.stop="toggleExpand">
...
<style lang="scss" scoped>
  .family-tree-node {
    ...
    &:hover {
      ...
      box-shadow: 0 8rpx 24rpx var(--theme-shadow-md);
    }
